...
public class WeatherReportModel {
    ...
    public WeatherReportModel(int id, String weather_state_name, String applicable_date, float min_temp, float max_temp, float the_temp, float wind_speed, int humidity, float visibility) {
        this.id = id;
...
//                "\nHumidity = " + humidity + "%" +
//                + "\nVisibility = " + (visibility * 1.60934) + " km"
                ;
    }
